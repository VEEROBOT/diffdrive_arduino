...
hardware_interface::return_type FakeRobot::read()
{
  ...
  f_l_wheel_.pos = f_l_wheel_.pos + f_l_wheel_.vel * deltaSeconds;
  f_r_wheel_.pos = f_r_wheel_.pos + f_r_wheel_.vel * deltaSeconds;  
  b_l_wheel_.pos = b_l_wheel_.pos + b_l_wheel_.vel * deltaSeconds;
  b_r_wheel_.pos = b_r_wheel_.pos + b_r_wheel_.vel * deltaSeconds;
...
hardware_interface::return_type FakeRobot::write()
{
  ...
  f_l_wheel_.vel = f_l_wheel_.cmd;
  f_r_wheel_.vel = f_r_wheel_.cmd;
  b_l_wheel_.vel = b_l_wheel_.cmd;
  b_r_wheel_.vel = b_r_wheel_.cmd;  
